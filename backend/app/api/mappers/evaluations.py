...
def map_api_request_to_engine_request(api_request: EvaluationRequest) -> EngineEvaluationRequest:
    return EngineEvaluationRequest(
        ...
        product_context=dict(api_request.product_context),
        external_inputs=[
...
def map_engine_result_to_api_response(
    *,
    ...
    return EvaluationResponse(
        ...
        product_result=_map_product_result(engine_result.product_result),
    )
...
def _map_product_result(product_result: dict[str, object]) -> dict[str, object] | None:
    return dict(product_result)
