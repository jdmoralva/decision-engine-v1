...
Definir la arquitectura del MVP de `Decision Engine` para `PLD / solicitudes de credito`, tomando como referencia funcional el legado en `old-version/` y como marco objetivo el `SPEC.md`.
